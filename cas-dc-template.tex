...
\title{
% The Continuum of Computing: an architecture for a seamless ubiquitous service-oriented platform to unite the Edge to the Cloud
% The continuum of computing
% Towards the Continuum of Computing: a view on the architecture, challenges and technologies
